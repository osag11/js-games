...
function getContrastBgColor() {
    let bgColor = model.background[model.backgroundIdx];
    let bgColorHex = colorByName(bgColor);
    let bgContrastColor = contrastColor(bgColorHex ?? bgColor ?? 'white');
    return bgContrastColor;
}
// --------------------------------------------------------------------------
