...
function demo() {
    ...
    Shapes.add(shapeData([pathPoint(10 + c, 100 + c), pathPoint(100, 50), pathPoint(100, 100), pathPoint(200, 50), pathPoint(200, 100), pathPoint(200, 250)], [], 'path', 'blue', false));
    ...
    Shapes.add(shapeData([pathPoint(10, 10 + a), pathPoint(100 + c, 50 + b), pathPoint(100 + a, 100 + a)], [], 'path', 'coral', true));
    ...
    Shapes.add(shapeData([], [0, 0, 50, 100, 80], 'arc', 'yellow', true));
}
